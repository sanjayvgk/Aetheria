...
const RoomDetailsPage = () => {
  const images = [
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772812473/7G0A8878-HDR_xxudzp.jpg",
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772812472/7G0A8872-HDR_t1ktwx.jpg",
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772812471/7G0A8863-HDR_nlng41.jpg",
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772812483/7G0A8961_sfh6v8.jpg"
  ];
  ...
  // --- NEW: Form State ---
  // Defaulting to today and tomorrow to prevent empty states
  ...
  const calculateNights = () => {
    ...
    return diffDays > 0 ? diffDays : 1; // Default to 1 night if dates are invalid/same
  };

  const nights = calculateNights();
  const basePricePerNight = 3500;
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
          ...
          <div className="mt-4 md:mt-0 md:text-right">
            <div className="text-gray-400 line-through text-sm font-medium">₹4,200</div>
            <div className="text-3xl font-bold text-[#1a1a1a]">₹3,500</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] rounded-2xl p-6 md:p-8">
              ...
              <p className="text-gray-600 text-[15px] leading-relaxed">
                Our 1BHK Service Apartment is the perfect retreat for couples and solo travelers seeking a home-like experience in the heart of Chikmagalur's coffee country.The apartment is serviced daily by our housekeeping team, ensuring your stay is comfortable and hassle-free throughout.
              </p>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 bg-white border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-2xl p-6">
              ...
              <div className="flex items-baseline mb-6">
                <span className="text-2xl font-bold text-gray-900 mr-1">₹3,500</span>
                ...
                <div className="grid grid-cols-2 border-b border-gray-300">
                  ...
                  <div className="p-3">
                    ...
                    <input 
                      type="date" 
                      value={checkOut}
                      min={checkIn} // Prevents check-out from being before check-in
    ...
    <BookingOptionsModal 
      ...
      // Passing the dynamic state directly to the modal
      checkIn={checkIn}
      checkOut={checkOut}
      guests={guests}
    />
