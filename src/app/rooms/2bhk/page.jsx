...
const RoomDetailsPage = () => {
  ...
  const images = [
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772810935/7G0A9039-HDR_eabp5o.jpg",
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772810935/7G0A8932-HDR_oswff9.jpg",
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772810935/7G0A8923-HDR_jhgcyw.jpg",
    "https://res.cloudinary.com/dk6awcsfk/image/upload/q_auto/f_auto/v1772810936/7G0A8970-HDR_r6ojca.jpg"
  ];
  ...
  const basePricePerNight = 10800; // Updated to match the ₹10,800 header price
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
          ...
          <div className="mt-4 md:mt-0 md:text-right">
            <div className="text-gray-400 line-through text-sm font-medium">₹10,800</div>
            <div className="text-3xl font-bold text-[#1a1a1a]">₹4,800</div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] rounded-2xl p-6 md:p-8">
              ...
              <p className="text-gray-600 text-[15px] leading-relaxed">
                Our 2BHK Dulex Service Apartment is the perfect retreat for couples and solo travelers seeking a home-like experience in the heart of Chikmagalur's coffee country.The apartment is serviced daily by our housekeeping team, ensuring your stay is comfortable and hassle-free throughout.
              </p>
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 bg-white border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] rounded-2xl p-6">
              ...
              <div className="flex items-baseline mb-6">
                <span className="text-2xl font-bold text-gray-900 mr-1">₹10,800</span>
